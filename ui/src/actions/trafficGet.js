...
export const RECEIVED_TRAFF_DATA_SUCCESS = 'RECEIVED_TRAFF_DATA_SUCCESS';
export const RECEIVING_TRAFF_DATA = 'RECEIVING_TRAFF_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_TRAFF_DATA_SUCCESS,
        payload
    }
}

export function getTraffic(params,callback,args) { 
