...
export const RECEIVED_CONSU_DATA_SUCCESS = 'RECEIVED_CONSU_DATA_SUCCESS';
export const RECEIVING_CONSU_DATA = 'RECEIVING_CONSU_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_CONSU_DATA_SUCCESS,
        payload
    }
}

export function consultantAdminUpdate(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/admin/consultants/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_CONSU_DATA_SUCCESS,
                payload: e.data.data
