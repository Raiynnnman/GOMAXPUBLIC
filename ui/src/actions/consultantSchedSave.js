...
export const RECEIVED_CONDSS_DATA_SUCCESS = 'RECEIVED_CONDSS_DATA_SUCCESS';
export const RECEIVING_CONDSS_DATA = 'RECEIVING_CONDSS_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_CONDSS_DATA_SUCCESS,
        payload
    }
}

export function saveConsultantSchedule(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/consultants/schedule/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_CONDSS_DATA_SUCCESS,
                payload: e.data.data
