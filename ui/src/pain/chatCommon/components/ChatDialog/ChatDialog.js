...
class ChatDialog extends Component {
  ...
  render() {
    ...
    <div className={`d-flex flex-column chat-dialog-section`} 
      ...
      <div className="d-lg-none chat-mobile-navigation px-0" 
            onClick={() => this.props.dispatch(changeMobileState(MobileChatStates.LIST))}>
      ...
      <form className={`chat-section ${s.newMessage} mb-0`} onSubmit={this.newMessage}>
        ...
        <Button color="danger" onClick={this.handleOutgoingMessage} className={`px-4 ${s.newMessageBtn}`} type="submit">
