...
class LegalAdminList extends Component {
    constructor(props) { 
        super(props);
        this.state = {
            selected: null,
    ...
    save() { 
        this.props.dispatch(legalAdminUpdate(this.state.selected,function(err,args) { 
            if (err) { 
            ...
            args.props.dispatch(getLegalAdmin({page:0,limit:10000},function(err,args) { 
              toast.success('Successfully saved legal.',
                {
                    position:"top-right",
                    autoClose:3000,
                    hideProgressBar:true
    ...
    render() {
        ...
        <>
            ...
            {(this.props && this.props.legalAdmin && this.props.legalAdmin.data && 
              this.props.legalAdmin.data.legals && this.state.selected === null) && ( 
            <>
            <Row md="12">
...
export default connect(mapStateToProps)(LegalAdminList);
