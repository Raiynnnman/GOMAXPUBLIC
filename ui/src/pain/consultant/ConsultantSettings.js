...
import { saveConsultantSchedule } from '../../actions/consultantSchedSave';
import { toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';

class ConsultantSettings extends Component {
    constructor(props) { 
        super(props);
        this.state = { 
    ...
    onSchedulingChange(e) { 
        ...
        this.props.dispatch(saveConsultantSchedule(params)).then(() => { 
...
export default connect(mapStateToProps)(ConsultantSettings);
