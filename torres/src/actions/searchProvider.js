...
export const RECEIVED_SRP_DATA_SUCCESS = 'RECEIVED_SRP_DATA_SUCCESS';
export const RECEIVING_SRP_DATA = 'RECEIVING_SRP_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_SRP_DATA_SUCCESS,
        payload
    }
}
