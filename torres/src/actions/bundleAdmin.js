...
export const RECEIVED_BUNDA_DATA_SUCCESS = 'RECEIVED_BUNDA_DATA_SUCCESS';
export const RECEIVING_BUNDA_DATA = 'RECEIVING_BUNDA_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_BUNDA_DATA_SUCCESS,
        payload
    }
}

export function getBundleAdmin(params,callback,args) { 
