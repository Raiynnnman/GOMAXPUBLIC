...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_CORPAS_DATA_SUCCESS,
        payload
    }
}

export function corporationAdminSave(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/admin/corporations/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_CORPAS_DATA_SUCCESS,
                payload: e.data.data
