...
export const RECEIVED_MYD_DATA_SUCCESS = 'RECEIVED_MYD_DATA_SUCCESS';
export const RECEIVING_MYD_DATA = 'RECEIVING_MYD_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_MYD_DATA_SUCCESS,
        payload
    }
}

export function getMyDay(params,callback,args) { 
