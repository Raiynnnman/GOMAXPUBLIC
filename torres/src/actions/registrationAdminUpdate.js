...
export const RECEIVED_REGUP_DATA_SUCCESS = 'RECEIVED_REGUP_DATA_SUCCESS';
export const RECEIVING_REGUP_DATA = 'RECEIVING_REGUP_DATA';
...
export function registrationAdminUpdate(params,callback,args) { 
