...
export const RECEIVED_MRECE_DATA_SUCCESS = 'RECEIVED_MRECE_DATA_SUCCESS';
export const RECEIVING_MRECE_DATA = 'RECEIVING_MRECE_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_MRECE_DATA_SUCCESS,
        payload
    }
}

export function mydayReceiptSave(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/myday/appointment/receipt/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_MRECE_DATA_SUCCESS,
                payload: e.data.data
