...
export const RECEIVED_CHATO_DATA_SUCCESS = 'RECEIVED_CHATO_DATA_SUCCESS';
export const RECEIVING_CHATO_DATA = 'RECEIVING_CHATO_DATA';
...
export function getChatOffice(params) { 
