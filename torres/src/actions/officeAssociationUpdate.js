...
export const RECEIVED_OFAU_DATA_SUCCESS = 'RECEIVED_OFAU_DATA_SUCCESS';
export const RECEIVING_OFAU_DATA = 'RECEIVING_OFAU_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_OFAU_DATA_SUCCESS,
        payload
    }
}

export function officeAssociationUpdate(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/office/associations/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_OFAU_DATA_SUCCESS,
                payload: e.data.data
