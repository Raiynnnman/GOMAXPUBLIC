...
export const RECEIVED_BUNDS_DATA_SUCCESS = 'RECEIVED_BUNDS_DATA_SUCCESS';
export const RECEIVING_BUNDS_DATA = 'RECEIVING_BUNDS_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_BUNDS_DATA_SUCCESS,
        payload
    }
}

export function bundleSave(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/office/bundle/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_BUNDS_DATA_SUCCESS,
                payload: e.data.data
