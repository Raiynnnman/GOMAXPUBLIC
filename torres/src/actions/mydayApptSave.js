...
export const RECEIVED_MYDSA_DATA_SUCCESS = 'RECEIVED_MYDSA_DATA_SUCCESS';
export const RECEIVING_MYDSA_DATA = 'RECEIVING_MYDSA_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_MYDSA_DATA_SUCCESS,
        payload
    }
}

export function mydayApptSave(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/myday/appointment/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_MYDSA_DATA_SUCCESS,
                payload: e.data.data
