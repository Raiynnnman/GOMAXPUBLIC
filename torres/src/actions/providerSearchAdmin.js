...
export const RECEIVED_PROCAS_DATA_SUCCESS = 'RECEIVED_PROCAS_DATA_SUCCESS';
export const RECEIVING_PROCAS_DATA = 'RECEIVING_PROCAS_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_PROCAS_DATA_SUCCESS,
        payload
    }
}

export function getProviderSearchAdmin(params) { 
