...
export const RECEIVED_USERA_DATA_SUCCESS = 'RECEIVED_USERA_DATA_SUCCESS';
export const RECEIVING_USERA_DATA = 'RECEIVING_USERA_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_USERA_DATA_SUCCESS,
        payload
    }
}
