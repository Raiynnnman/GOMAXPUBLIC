...
export const RECEIVED_BUNDU_DATA_SUCCESS = 'RECEIVED_BUNDU_DATA_SUCCESS';
export const RECEIVING_BUNDU_DATA = 'RECEIVING_BUNDU_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_BUNDU_DATA_SUCCESS,
        payload
    }
}

export function bundleAdminUpdate(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({
        ...
        }).post('/admin/bundle/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_BUNDU_DATA_SUCCESS,
                payload: e.data.data
