            ...
            <Grid item xs={12} sm={8}>
              <Box px={2}>
                ...
                <Box display="flex" alignItems="center">
                  <Rating size="small" value={Number(selected.lead_strength_id)} readOnly />
                ...
                {/* Address */}
                <Typography variant="body2" color="textSecondary" mt={1}>
                  Address: {selected.addr1}, {selected.zipcode}
                </Typography>
                <Typography variant="body2" color="textSecondary" mt={1}>
                  City: {selected.city}
                </Typography>
