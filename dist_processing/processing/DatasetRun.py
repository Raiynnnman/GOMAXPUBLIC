...
class DatasetRun(SubmitDataRequest):
    ...
    def etlToDatabase(self, name, data, mydb):
        ...
        query = "replace into dataset_registry (name,tblname,cols) values (%s,%s,%s)" 
    ...
    def execute(self, *args, **kwargs):
        ...
        query = "select d.name,columns, tables, groupby, orderby," \
            " whereclause,d.id from dataset d, queries q where " \
        ...
        query = "select name, script from dataset_list where dataset_id=%s"
